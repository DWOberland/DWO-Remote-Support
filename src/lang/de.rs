...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Verbinden mit dem DWO-Netzwerk …"),
        ...
        ("Website", "Webseite"),
        ("About", "Über"),
        ("Slogan_tip", "Digitalisierung fürs Oberland!"),
        ...
        ("install_tip", "Aufgrund der Benutzerkontensteuerung (UAC) kann der DWO Remote Support Client in manchen Fällen eingeschränkt funktionieren. Installieren Sie den Client, um alle Funktionen zu nutzen."),
        ("Click to upgrade", "Zum Upgraden klicken"),
        ("Configure", "Konfigurieren"),
        ("config_acc", "Um Ihren PC aus der Ferne zu steuern, müssen Sie DWO Zugriffsrechte erteilen."),
        ("config_screen", "Um aus der Ferne auf Ihren PC zugreifen zu können, müssen Sie DWO die Berechtigung \"Bildschirmaufnahme\" erteilen."),
        ...
        ("agreement_tip", "Durch die Installation akzeptieren Sie die Nutzungsbedingungen & Datenschutz."),
        ("Accept and Install", "Akzeptieren und Installieren"),
        ("End-user license agreement", "Nutzungsbedingungen & Datenschutz"),
        ...
        ("android_input_permission_tip1", "Damit ein entferntes Gerät Ihr Android-Gerät steuern kann, müssen Sie DWO Client erlauben, den Dienst \"Barrierefreiheit\" zu verwenden."),
        ("android_input_permission_tip2", "Bitte gehen Sie zur nächsten Systemeinstellungsseite, suchen Sie \"Installierte Dienste\" und schalten Sie den Dienst \"DWO Input\" ein."),
        ...
        ("Language", "Sprache"),
        ("Keep DWO Client background service", "DWO Client im Hintergrund ausführen"),
        ...
        ("Show DWO Client", "DWO Client anzeigen"),
        ("This PC", "Dieser PC"),
        ("or", "oder"),
        ...
        ("config_input", "Um den entfernten Desktop mit der Tastatur steuern zu können, müssen Sie DWO Client die Berechtigung \"Eingabeüberwachung\" erteilen."),
        ("config_microphone", "Um aus der Ferne sprechen zu können, müssen Sie DWO Client die Berechtigung \"Audio aufzeichnen\" erteilen."),
        ...
        ("still_click_uac_tip", "Der entfernte Benutzer muss immer noch im UAC-Fenster von DWO Client auf \"Ja\" klicken."),
        ...
        ("verify_rustdesk_password_tip", "DWO-Passwort bestätigen"),
        ...
        ("scam_text1", "Wenn Sie mit jemandem telefonieren, den Sie NICHT KENNEN, dem Sie NICHT VERTRAUEN und der Sie gebeten hat, DWO Remote Support zu benutzen und den Dienst zu starten, fahren Sie nicht fort und legen Sie sofort auf."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Bitte aktualisieren Sie DWO Server Pro auf die Version {} oder neuer!"),
        ...
        ("selinux_tip", "SELinux ist auf Ihrem Gerät aktiviert, was dazu führen kann, dass DWO Client als kontrollierte Seite nicht richtig läuft."),
        ...
        ("powered_by_me", "Unterstützt von Digitalwerk Oberland"),
        ("outgoing_only_desk_tip", "Dies ist eine benutzerdefinierte Ausgabe von DWO Remote Support.\nSie können eine Verbindung zu anderen Geräten herstellen, aber andere Geräte können keine Verbindung zu Ihrem Gerät herstellen."),
        ("preset_password_warning", "Dies ist eine benutzerdefinierte Ausgabe von DWO Client mit einem voreingestellten Passwort. Jeder, der dieses Passwort kennt, kann die volle Kontrolle über Ihr Gerät erlangen. Wenn Sie dies nicht beabsichtigen, deinstallieren Sie diese Software bitte umgehend."),
        ...
        ("allow-only-conn-window-open-tip", "Verbindung nur zulassen, wenn das DWO-Fenster geöffnet ist"),
        ...
        ("floating_window_tip", "Es hilft dabei, DWO im Hintergrund auszuführen."),
        ...
        ("About RustDesk", "Über Digitalwerk Oberland"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Bitte aktualisieren Sie den DWO-Client auf der Remote-Seite auf Version {} oder neuer!"),
        ...
        ("Install {} Printer", "DWO Remote Drucker installieren"),
        ...
        ("allow-insecure-tls-fallback-tip", "Standardmäßig überprüft DWO Client das Serverzertifikat für Protokolle, die TLS verwenden. Wenn diese Option aktiviert ist, überspringt der Client den Überprüfungsschritt und fährt im Falle eines Überprüfungsfehlers fort."),
        ("Disable UDP", "UDP deaktivieren"),
        ("disable-udp-tip", "Legt fest, ob nur TCP verwendet werden soll. Wenn diese Option aktiviert ist, verwendet DWO nicht mehr UDP 21116, sondern stattdessen TCP 21116."),
        ("server-oss-not-support-tip", "HINWEIS: DWO Server OSS enthält diese Funktion nicht."),
