...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Slogan_tip", "Digitalization for the Oberland!"),
        ...
        ("install_tip", "Due to UAC, DWO can not work properly as the remote side in some cases. To avoid UAC, please click the button below to install DWO Client to the system."),
        ("config_acc", "In order to control your Desktop remotely, you need to grant DWO Client \"Accessibility\" permissions."),
        ("config_screen", "In order to access your Desktop remotely, you need to grant DWO Client \"Screen Recording\" permissions."),
        ...
        ("android_input_permission_tip1", "In order for a remote device to control your Android device via mouse or touch, you need to allow DWO Client to use the \"Accessibility\" service."),
        ...
        ("android_open_battery_optimizations_tip", "If you want to disable this feature, please go to the next DWO Client application settings page, find and enter [Battery], Uncheck [Unrestricted]"),
        ...
        ("config_input", "In order to control remote desktop with keyboard, you need to grant DWO Client \"Input Monitoring\" permissions."),
        ("config_microphone", "In order to speak remotely, you need to grant DWO Client \"Record Audio\" permissions."),
        ...
        ("still_click_uac_tip", "Still requires the remote user to click OK on the UAC window of running DWO Client."),
        ...
        ("verify_rustdesk_password_tip", "Verify DWO Client password"),
        ...
        ("scam_text1", "If you are on the phone with someone you DON'T know AND TRUST who has asked you to use DWO Client and start the service, do not proceed and hang up immediately."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Please upgrade DWO Client Server Pro to version {} or newer!"),
        ...
        ("selinux_tip", "SELinux is enabled on your device, which may prevent DWO Client from running properly as controlled side."),
        ...
        ("powered_by_me", "Powered by Digitalwerk Oberland"),
        ...
        ("allow-only-conn-window-open-tip", "Only allow connection if DWO Client window is open"),
        ...
        ("floating_window_tip", "It helps to keep DWO Client background service"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Please upgrade the DWO Client client to version {} or newer on the remote side!"),
        ...
        ("allow-insecure-tls-fallback-tip", "By default, DWO Client verifies the server certificate for protocols using TLS.\nWith this option enabled, DWO Client will fall back to skipping the verification step and proceed in case of verification failure."),
        ("disable-udp-tip", "Controls whether to use TCP only.\nWhen this option enabled, DWO Client will not use UDP 21116 any more, TCP 21116 will be used instead."),
        ("server-oss-not-support-tip", "NOTE: DWO server OSS doesn't include this feature."),
